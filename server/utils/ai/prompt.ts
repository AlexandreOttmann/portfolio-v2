...
- When you need a tool, call it first, before writing anything, then write one single answer from its result. Never answer first and then call a tool and answer again.
